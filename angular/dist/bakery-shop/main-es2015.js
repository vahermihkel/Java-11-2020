    ...
    ngOnInit() {
        this.employeeService.getEmployees().subscribe(response => {
            response.data.forEach(employee => {
                this.employees.push(new _employee__WEBPACK_IMPORTED_MODULE_3__["Employee"](employee.id, employee.first_name + " " + employee.last_name, employee.email, employee.avatar));
            });
        });
        this.initForm();
    }
...
let ProductsComponent = class ProductsComponent {
    ...
    ngOnInit() {
        ...
        this.productService.getProducts().subscribe((products) => {
            this.products = products.sort((current, next) => {
